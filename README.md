...
![Awesome Marine Procurement Banner](assets/banner.svg)
...
| **[Procureship](https://www.procureship.com/)** | **~$5M - $8M Revenue**<br>*(Series A Venture Backed)* | **~$75/vessel/mo** *(Fixed Buyer Fee)* | **14-Day Full Trial** for fleet buyers;<br>**100% Free Permanent Tier** for basic suppliers | ML-driven maritime e-procurement marketplace offering automated vendor recommendation, RFQ optimization, and integration with ship management ERPs. |
...
| **[InvenTree Parts & Stock](https://github.com/inventree/InvenTree)** | [![InvenTree Stars](https://img.shields.io/github/stars/inventree/InvenTree?style=social)](https://github.com/inventree/InvenTree/stargazers) | Python, Django, React | Open-source inventory management and spare parts tracking system ideal for vessel engine room inventory and spare parts cataloging. |
| **[OpenBoxes Supply Chain](https://github.com/openboxes/openboxes)** | [![OpenBoxes Stars](https://img.shields.io/github/stars/openboxes/openboxes?style=social)](https://github.com/openboxes/openboxes/stargazers) | Java, Grails | Supply chain and warehouse management application supporting purchase requisitions, stock movements, and multi-location vessel inventory. |
| **[Keelson Maritime Framework](https://github.com/RISE-Maritime/keelson)** | [![Keelson Stars](https://img.shields.io/github/stars/RISE-Maritime/keelson?style=social)](https://github.com/RISE-Maritime/keelson/stargazers) | Rust, Python | Open-source data integration framework developed by RISE Maritime for vessel digital twins, sensor streams, and fleet connectivity. |
| **[Maritime Service Registry](https://github.com/maritimeconnectivity/ServiceRegistry)** | [![ServiceRegistry Stars](https://img.shields.io/github/stars/maritimeconnectivity/ServiceRegistry?style=social)](https://github.com/maritimeconnectivity/ServiceRegistry/stargazers) | Java, Spring Boot | Core Service Registry for the Maritime Connectivity Platform (MCP) enabling standardized digital maritime services and document exchange. |
| **[DNV Maritime Schema](https://github.com/dnv-opensource/maritime-schema)** | [![DNV Schema Stars](https://img.shields.io/github/stars/dnv-opensource/maritime-schema?style=social)](https://github.com/dnv-opensource/maritime-schema/stargazers) | JSON Schema, Python | DNV open-source data definitions and schemas for maritime operational data, safety interfaces, and vessel asset compliance. |
| **[Ship Chandler Hub](https://github.com/ryantusi/ShipChandlerHub)** | [![ShipChandlerHub Stars](https://img.shields.io/github/stars/ryantusi/ShipChandlerHub?style=social)](https://github.com/ryantusi/ShipChandlerHub/stargazers) | PHP, Laravel | Web application reference implementation for ship chandlers featuring IMPA-coded inventory management, order processing, and vessel tracking. |
| **[Ship & Cargo Matching](https://github.com/jasonliu62/ship-and-cargo-dev)** | [![Ship & Cargo Stars](https://img.shields.io/github/stars/jasonliu62/ship-and-cargo-dev?style=social)](https://github.com/jasonliu62/ship-and-cargo-dev/stargazers) | Java, Spring Boot | Backend microservice platform for matching dry bulk cargo requisitions with vessel capacity and chartering schedules. |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Marine-Procurement&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Marine-Procurement&type=date&legend=top-left)
...
<a href="https://github.com/sponsors/ishandutta2007">
  <img src="https://img.shields.io/badge/Sponsor%20%E2%9D%A4-ishandutta2007-ff69b4?style=for-the-badge&logo=github-sponsors" alt="Sponsor Maintainer"/>
</a>
...
<div align="center">
  <sub>Maintained with ❤️ for ship managers, fleet operators, maritime software engineers & marine procurement officers worldwide.</sub><br>
